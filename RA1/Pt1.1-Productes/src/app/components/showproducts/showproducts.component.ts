...
constructor(private activatedRoute: ActivatedRoute) {
  this.activatedRoute.paramMap.subscribe((parametros: ParamMap) => {
    ...
    this.find = this.articulos.find(x =>
      x.nom.toLowerCase().includes(this.nombre.toLowerCase()) ||
      x.descripcio.toLowerCase().includes(this.nombre.toLowerCase()) ||
      x.preu.toString().includes(this.nombre)
    );
  });
}
